...
export class CreateDeviceFormService {
  ...
  public get tuyaIdControl(): FormControl<string> {
    return this._form.get(CreateDeviceFormName.TUYA_DEVICE_ID) as FormControl<string>;
  }
  ...
  private _prepareForm(): FormGroup<CreateDeviceForm> {
    return this._fb.group({
      ...
      [CreateDeviceFormName.TUYA_DEVICE_ID]: this._fb.control<string>('', {
