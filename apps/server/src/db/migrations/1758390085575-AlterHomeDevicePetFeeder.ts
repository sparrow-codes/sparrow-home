...
export class AlterHomeDevicePetFeeder1758390085575 implements MigrationInterface {
  private readonly _configService: ConfigService = new ConfigService();

  private readonly _columns: TableColumn[] = [
    new TableColumn({ name: 'feederPortionSize', type: 'decimal', isNullable: true }),
    new TableColumn({ name: 'feederNumberOfPortions', type: 'decimal', isNullable: true }),
  ];
